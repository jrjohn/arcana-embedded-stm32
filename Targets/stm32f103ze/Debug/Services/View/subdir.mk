...
Services/View/%.o Services/View/%.su Services/View/%.cyclo: ../Services/View/%.cpp Services/View/subdir.mk
...
clean: clean-Services-2f-View

clean-Services-2f-View:
	-$(RM) ./Services/View/MainView.cyclo ./Services/View/MainView.d ./Services/View/MainView.o ./Services/View/MainView.su

.PHONY: clean-Services-2f-View
